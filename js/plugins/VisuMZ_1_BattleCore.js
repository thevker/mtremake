...
//=============================================================================
 /*:
 * @target MZ
 * @plugindesc [RPG Maker MZ] [Tier 1] [Version 1.27] [BattleCore][翻譯版本:3]
 * @author VisuStella
 ...
 * <Battle UI Offset Y: -y>
 * 
 * - 用於: Actor and Enemy Notetags
 * - 調整角色和敵人頭部上方的HP儀表和狀態圖標的偏移量。
 * - 將"x"替換為偏移x坐標的數字值。
 * - x負值向左偏移。正x值向右偏移。
 * - 將"y"替換為偏移y坐標的數字值。
 * - 負y值向上偏移。正x值向下偏移。
 ...
 * 以下註釋標籤使你可以設置動畫，使其在某些情況下和/或條件下播放。
 * ------ ------ ------ ------ ------ ------
 * <Slip Animation: x>
 *
 * - 需要VisuMZ_0_CoreEngine!
 * - 用於: Actor, Class, Weapon, Armor, Enemy, State Notetags
 * - 在使用者重新生成HP，MP或TP的階段，只要使用者還活著並且可見，就會播放此動畫。
 * - 將"x"替換為代表要播放的動畫ID的數字值。
 * ------ ------ ------ ------ ------ ------
 * <Cast Animation: x>
 *
 * - 用於: Skill Notetags
 ...
 * 你可以應用這些便籤來控制出現在地圖不同區域中的回擊，以進行隨機或接觸遭遇。
 * ------ ------ ------ ------ ------ ------
 * <Region x Battleback1: filename>
 * <Region x Battleback2: filename>
 * 
 * - 用於: Map Notetags
 * - 如果玩家站在"x"區域上開始戰鬥，那麼將使用"filename"對戰。
 * - 將"x"替換為代表你要使用的區域ID的數字。
 * - 將"filename"替換為要使用的圖形的文件名。不要插入任何擴展名。這意味著文件"Castle1.png"將僅作為"Castle1"插入而末尾沒有".png"。
 * - *注意：這將覆蓋所有指定的反擊設置。
 * ------ ------ ------ ------ ------ ------
 ...
 *
 * - 用於: Class Notetags
 * - 更改戰鬥中Actor命令窗口中顯示的命令。如果未使用此便簽標籤，則將使用在插件參數=> Actor命令窗口=>命令列表中確定的默認命令。
 * - 根據需要添加/刪除/修改條目。
 *
 * - Attack 
 * 
 ...
 *
 * - 用於: Skill Notetags
 * - 在<Battle Commands>註釋標籤集中使用一項技能時，你可以將顯示的技能名稱文本更改為其他名稱。
 * - 將"x"替換為要在"Actor Battle Command"窗口中顯示的技能名稱。
 * - 推薦的用法：縮短技能名稱，否則該名稱太大而無法容納在Actor Battle Command窗口中。
 * ------ ------ ------ ------ ------ ------
 * <Command Icon: x>
 *
 * - 用於: Skill Notetags
 * - 如果在<Battle Commands>而不是標籤集中使用了一項技能，則可以將顯示的技能圖標更改為其他內容。
 * - 將"x"替換為要在"Actor Battle Command"窗口中顯示的代表該技能的圖標的ID。
 * ------ ------ ------ ------ ------ ------ 
 ...
 * - 如果使用'Any'記事標籤變體，則任何一個開關為ON時，該項目將被隱藏。否則，將顯示出來。
 * - 這也可以應用於"攻擊"和"防禦"命令。
 * ------ ------ ------ ------ ------ ------  
 ...
 * - 用於: Actor
 * - 與"縱向"戰鬥佈局一起使用。
 * - 將角色的戰鬥肖像圖像設置為"filename"。
 * - 將"filename"替換為在遊戲項目的img/pictures/文件夾中找到的圖片。文件名區分大小寫。從註釋標籤中刪除文件名擴展名。
 * - 這將覆蓋僅用於戰鬥的所有菜單圖像。
 * ------ ------ ------ ------ ------ ------  
 ...
 * 
 * - 用於: Skill Notetags
 * - "visible"變量是最終返回的變量，用於確定技能在"戰場指揮"窗口中的可見性。
 * - 用JavaScript代碼替換"code"，以確定技能在"戰場指揮"窗口中的可見性。
 * - "user"變量表示將執行該技能的使用者。
 * - "skill"變量表示要使用的技能。
 * ------ ------ ------ ------ ------ ------ 
 * === Targeting-Related Notetags ===
 * 以下註釋標籤與技能和項目的定位方面有關，並且可能會調整某些技能/項目的工作範圍。
 * ------ ------ ------ ------ ------ ------
 * <Always Hit>
 *
 * <Always Hit Rate: x%>
 *
 * - 用於: Skill, Item Notetags
 * - 使動作始終命中或始終具有恰好標記為x%的命中率。
 * - 將"x"替換為代表點擊成功率的數字值。
 * ------ ------ ------ ------ ------ ------
 * <Repeat Hits: x>
 *
 ...
 *
 * - 用於: Skill, Item Notetags
 * - "targets"變量是一個數組，將返回該數組以用作所有有效操作目標的容器。
 * - 用JavaScript代碼替換"code"以確定有效的目標。
 * ------ ------ ------ ------ ------ ------
 ...
 *
 * - 用於: Skill, Item Notetags
 * - 用"損壞樣式"名稱替換"name"，以更改使用損壞公式輸入框進行計算的方式。
 * - 可以在插件參數=>損壞設置=>樣式列表中找到名稱
 * ------ ------ ------ ------ ------ ------
 * <Armor Reduction: x>
 * <Armor Reduction: x%>
 * - 用於: Actor, Class, Skill, Item, Weapon, Armor, Enemy, State Notetags
 * - 如果用於技能和/或物品，請將當前技能/物品的護甲降低屬性設置為"x"和/或"x%"。
 * - 如果用於特徵對象，則在計算自己的護甲時添加"x"和/或"x%"的護甲減少屬性。
 * - 這適用於物理攻擊。
 * - 使用'x'notetag變量來確定平坦的減少值。
 * - 使用'x%'註釋標籤變體來確定百分位數減少值。
 * ------ ------ ------ ------ ------ ------
 * <Armor Penetration: x>
 * <Armor Penetration: x%>
 * - 用於: Actor, Class, Skill, Item, Weapon, Armor, Enemy, State Notetags
 * - 如果用於技能和/或物品，請將當前技能/物品的裝甲穿透屬性設置為"x"和/或"x%"。
 * - 如果用於特徵對象，則在計算目標的護甲時添加"x"和/或"x%"的護甲穿透屬性。
 * - 這適用於物理攻擊。
 * - 使用'x'notetag變量來確定平坦的穿透值。
 * - 使用'x%'註釋標籤變體來確定百分位穿透值。
 * ------ ------ ------ ------ ------ ------
 * <Magic Reduction: x>
 * <Magic Reduction: x%>
 * - 用於: Actor, Class, Skill, Item, Weapon, Armor, Enemy, State Notetags
 ...
 * 
 * - 用於: Actor, Class, Skill, Item, Weapon, Armor, Enemy, State Notetags
 * - 如果用於技能和/或物品，這將導致動作永遠不會受到傷害上限的限制。
 * - 如果用於特徵對象，這將導致受影響的單位永遠不會受到傷害上限的限制。
 * ------ ------ ------ ------ ------ ------
 * <Damage Cap: x>
 *
 * - 用於: Actor, Class, Skill, Item, Weapon, Armor, Enemy, State Notetags
 * - 如果用於技能和/或物品，則將硬傷上限定為"x"值。
 * - 如果在特徵對像上使用，這會將受影響單位的硬傷上限提高到"x"值。如果另一個特徵對象具有更高的值，請改用該值。
 * ------ ------ ------ ------ ------ ------
 * <Bypass Soft Damage Cap>
 *
 * - 用於: Actor, Class, Skill, Item, Weapon, Armor, Enemy, State Notetags
 * - 如果用於技能和/或物品，這將導致動作的傷害永遠不會減小到軟上限。
 * - 如果在特質對像上使用，這將導致受影響的單位永遠不會將其傷害減小到軟上限。
 * ------ ------ ------ ------ ------ ------
 * <Soft Damage Cap: +x%>
 * <Soft Damage Cap: -x%>
 *
 * - 用於: Actor, Class, Skill, Item, Weapon, Armor, Enemy, State Notetags
 * - 如果用於技能和/或物品，這將使動作的軟上限增加/減少x%，其中"x"是一個百分比值，代表由硬上限值更改的增量。
 * - 如果在特徵對像上使用，這會將受影響單位的軟傷害限制提高x%，其中"x"是一個百分比值，代表由硬頂值更改的增量。
 * ------ ------ ------ ------ ------ ------
 * <Unblockable>
 *
 * - 用於: Skill, Item Notetags
 ...
 * 以下註釋標籤會影響技能和物品的致命命中率以及致命傷害倍數。
 * ------ ------ ------ ------ ------ ------
 * <Always Critical>
 *
 * - 用於: Skill, Item Notetags
 * - 無論使用者的CRI參數值如何，此技能/項目將始終獲得致命一擊。
 * ------ ------ ------ ------ ------ ------
 * <Set Critical Rate: x%>
 *
 * - 用於: Skill, Item Notetags
 * - 不管使用者的CRI參數值如何，此技能/物品將始終具有x%的變化以命中關鍵命中。
 * - 用表示成功率的確定值替換"x"。
 * ------ ------ ------ ------ ------ ------
 ...
 * - 用於: Skill, Item Notetags
 * - 修改此技能/項目的使用者CRI參數計算。
 * - "x%"註釋標籤變體將為此技能/項目增加使用者的CRI參數值。
 * - "+ x%"和"-x%"便簽變體將針對此技能/項目漸進地增加/減少使用者的CRI參數值。
 * ------ ------ ------ ------ ------ ------
 ...
 * - 這些標籤在重擊命中時確定傷害倍數。
 * - "x%"註釋標籤變體將乘數乘以該精確百分比。
 * - '+ x%'和'-x%'notetag變體將以該技能/項目的漸進速率改變乘數。
 * ------ ------ ------ ------ ------ ------
 ...
 * - 這些便簽確定了重擊命中時增加的額外傷害。
 * - 'x%'筆記標籤變體將傷害乘以該確切百分比。
 * - "+x%"和"-x%"音符標籤變體將以此技能/物品的漸進速率改變獎勵傷害。
 * ------ ------ ------ ------ ------ ------
 ...
 *
 * 動作序列使你可以完全控制技能和/或項目在其整個過程中的發揮方式。
 * 這些便簽標籤使你可以控制這些動作序列的各個方面。
 * 有關更多信息，請參見"動作序列"幫助部分。
 * ------ ------ ------ ------ ------ ------
 * <Custom Action Sequence>
 *
 * - 用於: Skill, Item Notetags
 * - 從技能中移除所有自動動作序列部分。
 * - 與動作序列有關的所有事情都將由"公共事件"完成。
 * - 將常見事件插入技能/項目的效果列表，以使用"自定義動作序列"。
 * - 當在戰場外使用時，這將防止常見事件載入項目場景和技能場景中。
 * ------ ------ ------ ------ ------ ------ 
 * <Auto Action Sequence>
 * 
 * - 用於: Skill, Item Notetags
 * - 如果啟用了動作序列插件參數"自動註釋標籤"，則此插件將阻止技能或物品發生自定義動作序列，而應改用"自動動作序列"。
 * - 如果禁用了"自動註釋標籤"或將其設置為false，請忽略此設置。
 * ------ ------ ------ ------ ------ ------  
 * <Common Event: name>
 *
 * - 用於: Skill, Item Notetags
 * - 僅限戰鬥：召喚一個名字匹配的普通事件。
 * - 在戰鬥中使用此技能/物品時，將"name"替換為要呼叫的普通事件的名稱。
 *   - 刪除名稱中的所有\I[x]。
 * - 插入多個便簽以連續調用多個公共事件。
 * - 在技能/項目的數據庫條目發生任何常見事件特效後，就會發生這種情況。
 * - 這主要用於正在圍繞"常見事件"進行重組並且仍希望其技能/項目執行正確操作順序（以防ID不同）的使用者。
 * ------ ------ ------ ------ ------ ------ 
 * <Display Icon: x>
 * <Display Text: string>
 *
 * - 用於: Skill, Item Notetags
 * - 在"動作序列"中顯示技能/物品名稱時，請確定顯示的圖標和/或文本。
 * - 將"x"替換為代表要顯示的圖標ID的數字值。
 * - 將"字符串"替換為代表顯示名稱的文本值。
 * ------ ------ ------ ------ ------ ------
 * === Animated Sideview Battler-Related Notetags ===
 *
 * 由於有了此插件，敵人可以使用Animated Sideview Actor圖形。
 * 這些便簽標籤使你可以控制該方面。
 * 這些中的一些還影響了除敵人之外的角色。
 * ------ ------ ------ ------ ------ ------
 ...
 *
 * - 用於: Enemy Notetags
 * - 用在img/sv_actors/文件夾中找到的動畫Sideview Actor圖形替換敵人的戰鬥機圖形。
 * - 將"filename"替換為要使用的圖形的文件名。不要插入任何擴展名。這意味著文件"Actor1_1.png"將僅作為"Actor1_1"插入，結尾沒有".png"。
 * - 如果使用了多個便簽標籤，則在創建敵人時會從列表中選擇一個隨機文件名。
 * - 用代表"filename"出現頻率的數字值替換"weight"。權重越高，就越頻繁。你可以省略此名稱和冒號（:)，而只需鍵入"filename"。
 * - 根據需要添加/刪除線。
 *
 * Example:
 *
 ...
 * <Sideview Anchor: x, y>
 *
 * - 用於: Actor, Enemy Notetags
 * - 設置側視圖精靈的精靈錨點位置。
 * - 將"x"和"y"替換為數字，以表示側面視鏡精靈的錨點應在何處。
 * - 默認情況下，x和y錨點分別為0.5和1.0。
 * ------ ------ ------ ------ ------ ------ 
 * <Sideview Home Offset: +x, +y>
 * <Sideview Home Offset: -x, -y>
 * 
 * - 用於: Actor, Class, Weapon, Armor, State Notetags
 * - 將側面Actor子畫面的原始位置偏移+/- x，+ /-y。
 * - 將"x"和"y"替換為描述每個坐標要偏移多少的數字。對於"0"值，請使用+0或-0。
 * - 如果你將該註釋標籤從"插件參數">"Actor">"JS：原始位置"中的JavaScript代碼中刪除，則將無法使用
 * ------ ------ ------ ------ ------ ------  
 ...
 *     'abnormal', 'sleep', 'dead'
 * - 如果使用多個註釋標籤，則在創建敵人時從列表中選擇一個隨機動作名稱。
 ...
 * - 用於: Enemy Notetags
 * - 需要VisuMZ_1_ElementStatusCore
 * - 允許某些特質套裝使戰鬥人員擁有獨特的武器。
 * - 將"武器類型"替換為在"數據庫=>類型=>武器類型"列表下找到的武器類型的名稱（無文本代碼）。
 * - 如果使用多個便簽，則在創建敵人時會從列表中選擇一種隨機武器類型。
 * - 用代表武器類型出現頻率的數字值替換"weight"。權重越高，就越頻繁。你可以省略此代碼和冒號（:)，而只需鍵入"武器類型"即可。
 * - 根據需要添加/刪除線。
 *
 * Examples:
 *
 ...
 *
 * - 用於: Enemy Notetags
 * - 防止敵人由於動作序列而無法移動，跳躍和/或漂浮。對生根的敵人有用。
 * ------ ------ ------ ------ ------ ------ 
 * <Battler Sprite Grounded>
 *
 * - 用於: Enemy Notetags
 * - 防止敵人由於動作序列而能夠跳躍和/或漂浮但仍然能夠移動。對生根的敵人有用。
 * ------ ------ ------ ------ ------ ------ 
 * <Swap Enemies>
 *  name: weight
 *  name: weight
 ...
 *
 * - 用於: Enemy Notetags
 * - 使此敵人數據庫對象充當筆記標記內任何列出的敵人的隨機分配器。
 *   當敵人被載入戰場時，立即將其替換為所列敵人之一。
 *   隨機分配是基於賦予每個敵人"名字"的"weight"。
 * - 將"name"替換為你要替換為敵人的敵人的數據庫敵人。
 * - 用代表"name"出現頻率的數字值替換"weight"。權重越高，就越頻繁。你可以省略此名稱和冒號（:)，而只需鍵入"name"即可。
 * - 根據需要添加/刪除線。
 *
 * Example:
 ...
 * - 更改用於此特定地圖或戰鬥的戰鬥佈局樣式。
 * - 將 'type' 替換為 'default', 'list', 'xp', 'portrait', or 'border'.
 * ------ ------ ------ ------ ------ ------ 
 * ============================================================================
 * Introduction
 * ============================================================================
 ...
 * @text 動作序列 - 動作集(Action Sets)
 * @desc 動作序列動作集是常用動作序列命令的組合，可以更有效地使用。
 *
 * @ --------------------------------------------------------------------------
 *
 ...
 * @arg Duration:eval
 * @text 耗時
 * @desc 以幀為單位的持續時間，以更改相機角度。
 * @default 60
 *
 * @arg EasingType:str
 * @text 角度緩進(Angle Easing)
 * @type combo
 * @option Linear
 * @option InSine
 * @option OutSine
 ...
 * @text 角度: 等待角度
 * @desc 等待角度更改完成，然後再執行下一個命令。
 * 需要VisuMZ_3_ActSeqCamera！
 *
 * @ --------------------------------------------------------------------------
 *
 ...
 * @text 動作序列 - 動畫(Animations)
 * @desc 這些動作序列與"動畫"相關，可在數據庫的"動畫"選項中找到。
 *
 * @ --------------------------------------------------------------------------
 *
 ...
 * @text 動作順序 - 戰鬥記錄(Battle Log)
 * @desc 這些動作序列與戰鬥日誌窗口相關，該窗口位於戰鬥屏幕頂部。
 *
 * @ --------------------------------------------------------------------------
 *
 ...
 * @text BTLOG: 流行基準線 (Pop Base Line)
 * @desc 刪除戰鬥日誌的最後添加的基線以及所有文本，直到其原來的位置。
 *
 * @ --------------------------------------------------------------------------
 *
 * @command ActSeq_BattleLog_PushBaseLine
 * @text BTLOG: 推基線 (Push Base Line)
 * @desc 向戰鬥日誌當前所在的位置添加新的基線。
 *
 * @ --------------------------------------------------------------------------
 *
 ...
 * @text 動作序列 - (龍骨)Dragonbones
 * @desc 這些動作序列與龍骨有關。
 * 需要VisuMZ_2_DragonbonesUnion！
 *
 * @ --------------------------------------------------------------------------
 *
 ...
 * @arg MotionAni:str
 * @text 運動動畫
 * @desc 您要播放的龍骨動作動畫的名稱是什麼？
 * @default attack
 *
 * @ --------------------------------------------------------------------------
 *
 * @command ActSeq_DB_DragonbonesTimeScale
 * @text DB: 龍骨時間刻度 (Time Scale)
 ...
 * @text ELE: 清除元素更改
 * @desc 清除通過操作序列進行的所有元素更改。
 * 需要VisuMZ_1_ElementStatusCore！
 *
 * @ --------------------------------------------------------------------------
 *
 * @command ActSeq_Element_ForceElements
 * @text ELE: 力元素 (Force Elements)
 * @desc 計算損壞時僅強制使用特定元素。
 * 需要VisuMZ_1_ElementStatusCore！
 *
 * @arg Elements:arraynum
 ...
 * @text ELE: 空元素 (Null Element)
 * @desc 強制在計算損壞時不使用任何元素。
 * 需要VisuMZ_1_ElementStatusCore！
 *
 * @ --------------------------------------------------------------------------
 *
 ...
 * @text 動作序列 - 恐怖效果 (Horror Effects)
 * @desc 這些動作序列與恐怖效應有關。
 * 需要VisuMZ_2_HorrorEffects！
 *
 * @ --------------------------------------------------------------------------
 *
 * @command ActSeq_Horror_Clear
 * @text HORROR: 清除所有濾鏡 (Filters)
 * @desc 清除目標戰鬥人員身上的所有恐怖效果過濾器(Filters)。
 * 
 * @arg Targets:arraystr
 * @text 目標
 * @type combo[]
 ...
 * @text 動作順序 - 影響 (Impact)
 * @desc 這些行動順序與創造影響力有關。
 * 需要VisuMZ_3_ActSeqImpact！
 *
 * @ --------------------------------------------------------------------------
 *
 * @command ActSeq_Impact_ColorBreak
 * @text IMPACT: 色彩斷裂 (Color Break)
 * @desc 重新組裝之前，請先打破屏幕上的顏色。
 * 需要VisuMZ_3_ActSeqImpact！
 * 
 * @arg Intensity:eval
 * @text 強度/亮度 (Intensity)
 * @desc 分色效果的強度是多少？
 * @default 60
 * 
 * @arg Duration:eval
 ...
 * @text IMPACT: 點衝擊波 (Shockwave at Point)
 ...
 * @text 動作序列 - 力學 (Mechanics)
 * @desc 這些動作序列與與戰鬥系統有關的各種機制有關。
 *
 * @ --------------------------------------------------------------------------
 *
 * @command ActSeq_Mechanics_ActionEffect
 * @text MECH: 動作效果
 * @desc 使單位從行動中受到傷害/治療，並引起任何改動，例如增益和狀態。
 * 
 * @arg Targets:arraystr
 * @text 目標
 * @type combo[]
 ...
 * 
 * @arg ChargeRate:eval
 * @text 收費率 (Charge Rate)
 * @parent Charging
 * @desc 如果正在充電，則對ATB電量計進行更改。
 * @default -0.00
 * 
 * @arg Casting
 * 
 ...
 * @text MECH: 打破盾牌變化
 * @desc Changes 如果沒有擊暈，則擊破目標的盾牌。
 * 需要VisuMZ_4_BreakShields！
 * 
 * @arg Targets:arraystr
 * @text 目標
 * @type combo[]
 ...
 * @text MECH: BTB勇敢點 (BTB Brave Points)
 * @desc Alters the target(s) Brave Points to an exact value.
 * 需要VisuMZ_2_BattleSystemBTB！
 * 
 * @arg Targets:arraystr
 * @text 目標
 * @type combo[]
 ...
 * @text MECH: 傷害彈出 (Damage Popup)
 * @desc 使設備顯示已收到或已修復的損壞的當前狀態。
 * 
 * @arg Targets:arraystr
 * @text 目標
 * @type combo[]
 ...
 * @text MECH: 死標籤跳 (Dead Label Jump)
 * @desc 如果現役戰鬥者已死，則在常見事件中跳至特定標籤。
 * 
 * @arg JumpToLabel:str
 * @text 跳轉到標籤 (Jump To Label)
 * @desc 如果活動的戰鬥者死亡，請在常見事件中跳至該特定標籤。
 * @default Untitled
 *
 * @ --------------------------------------------------------------------------
 *
 ...
 * @text MECH: 不死 (Immortal)
 * @desc 改變目標的永生標記。 如果不朽旗幟被移除而一個單位將死亡，則將該單位倒塌。
 * 
 * @arg Targets:arraystr
 * @text 目標
 * @type combo[]
 ...
 * @text MECH: 乘數 (Multipliers)
 * @desc 更改當前操作的乘數。
 * 您可以對其中任何一個使用JavaScript代碼。
 *
 * @arg CriticalHit
 * @text 暴擊% (Critical Hit%)
 * 
 ...
 * @text MECH: STB 利用效果 (Exploit Effect)
 * @desc Utilize the STB Exploitation mechanics!
 * 需要VisuMZ_2_BattleSystemSTB！
 * 
 * @arg Exploited:eval
 ...
 * @on Show
 * @off Hide
 * @desc 如果使用"攻擊"，"推力"，"擺動"或"導彈"，顯示武器精靈？
 * @default true
 *
 * @ --------------------------------------------------------------------------
 *
 ...
 * @option 正常 - 未進行任何調整
 * @value none
 * @option 水平 - 角色向左調整，敵人向右調整
 * @value horz
 * @option 垂直 - 角色上調，敵人下調
 * @value vert
 * @option 兩者 - 同時應用水平和垂直
 * @value horz + vert
 * @desc 調整距離值，以確定移動單位的方向。
 * @default horz
 * 
 * @arg DistanceX:eval
 * @text 距離: X
 ...
 * @text 恢復完成角度 (Revert Angle on Finish)
 * @type boolean
 * @on Revert
 * @off Don't
 ...
 * @text MOVE: 等待運動 (Movement)
 * @desc Waits for movement to complete before performing next command.
 *
 * @ --------------------------------------------------------------------------
 *
 * @command ActSeq_Movement_WaitForOpacity
 * @text MOVE: 等待不透明度 (Opacity)
 * @desc Waits for opacity changes to complete before performing next command.
 *
 * @ --------------------------------------------------------------------------
 *
 * @command ActSeq_Movement_WaitForScale
 * @text MOVE: 等待比例 (Scale)
 ...
 * @text 動作序列 - 彈丸 (Projectiles)
 * @desc 在屏幕上創建彈丸，然後向目標發射。
 * 需要VisuMZ_3_ActSeqProjectiles！
 *
 * @ --------------------------------------------------------------------------
 *
 ...
 * @text 動作順序 - 目標 (Target)
 * @desc 如果按目標操作序列使用手動目標，則這些命令將使您完全控制其用法。
 *
 * @ --------------------------------------------------------------------------
 *
 ...
 * @arg JumpToLabel:str
 * @text 跳轉到標籤
 * @desc 如果在更改索引後找到目標，請跳至"公共事件"中的該標籤。
 * @default Untitled
 *
 * @ --------------------------------------------------------------------------
 *
 ...
 * @arg JumpToLabel:str
 * @text 跳轉到標籤
 * @desc 如果在更改索引後找到武器，請跳至"常見事件"中的該標籤。
 * @default Untitled
 *
 * @ --------------------------------------------------------------------------
 *
 ...
 * @arg SlotID:eval
 * @text 武器槽 ID
 * @desc 選擇武器槽以激活（使其他武器無效）。
 * 使用0清除並標準化。 您可以使用JavaScript代碼。
 * @default 1
 *
 * @ --------------------------------------------------------------------------
 *
 ...
 * @desc 調整Window_BattleLog行為方式的設置。
 ...
 * @on 允許
 * @off 禁用
 * @desc 是否允許根據用戶的AGI隨機分配速度？
 * @default false
 *
 * @param CalcActionSpeedJS:func
 * @text JS: 計算 Calculate
 * @parent ActionSpeed
 * @type note
 ...
 * @text JS: 計算逃逸率 Calc Escape Ratio
 * @parent Escape
 * @type note
 ...
 * @text JS: Calc逃生加成 Calc Escape Raise
 * @parent Escape
 * @type note
 ...
 *
 * @param BattleJS
 * @text JS: 與戰鬥有關 Battle-Related
 * 
 * @param PreStartBattleJS:func
 * @text JS: 開始前戰鬥 Pre-Start Battle
 * @parent BattleJS
 * @type note
 ...
 * @text JS: 出發後戰鬥 Post-Start Battle
 * @parent BattleJS
 * @type note
 * @desc Target function: BattleManager.startBattle()
 * JavaScript code occurs after function is run.
 ...
 *
 * @param TurnJS
 * @text JS: 轉向相關 Turn-Related
 *
 * @param PreStartTurnJS:func
 * @text JS: 出發前轉彎 Pre-Start Turn
 * @parent TurnJS
 * @type note
 ...
 *
 * @param ActionJS
 * @text JS: 動作相關 Action-Related
 *
 * @param PreStartActionJS:func
 * @text JS: 啟動前動作 Pre-Start Action
 * @parent ActionJS
 * @type note
 ...
 * @text JS: 啟動後動作 Post-Start Action
 * @parent ActionJS
 * @type note
 * @desc Target function: BattleManager.startAction()
 * JavaScript code occurs after function is run.
 ...
 * @text 戰鬥佈局樣式
 * @type select
 * @option 預設 - 在戰鬥狀態中顯示角色臉譜。
 * @value default
 * @option 列表 - 列出處於戰鬥狀態的角色。
 * @value list
 * @option XP - 向角色戰鬥者顯示展開的戰鬥狀態。
 * @value xp
 * @option 肖像 - 以延伸的戰鬥狀態顯示肖像。
 * @value portrait
 * @option 邊框 - 在屏幕邊框周圍顯示窗口。
 * @value border
 * @desc 用於戰鬥佈局的樣式。
 * @default default
 *
 ...
 * @option 1:1 （無縮放比例）
 * @value 1:1
 * @option Scale To Fit （縮放到屏幕尺寸）
 * @value ScaleToFit
 * @option Scale Down （如果大於屏幕，則向下縮放）
 * @value ScaleDown
 * @option Scale Up （如果小於屏幕，則向上縮放）
 * @value ScaleUp
 * @desc 用於回擊的默認縮放樣式。
 * @default MZ
 *
 ...
 * @text JS: 縮放以適合 Scale To Fit
 * @type note
 * @desc This code gives you control over the scaling for this style.
 * @default "// Adjust Size\nthis.width = Graphics.width;\nthis.height = Graphics.height;\n\n// Adjust Scale\nconst ratioX = this.width / this.bitmap.width;\nconst ratioY = this.height / this.bitmap.height;\nconst scale = Math.max(ratioX, ratioY);\nthis.scale.x = scale;\nthis.scale.y = scale;\n\n// Adjust Coordinates\nthis.x = (Graphics.width - this.width) / 2;\nthis.y = Graphics.height - this.height;"
 *
 * @param jsScaleDown:func
 * @text JS: 縮小 Scale Down
 * @type note
 * @desc This code gives you control over the scaling for this style.
 * @default "// Adjust Size\nthis.width = Graphics.width;\nthis.height = Graphics.height;\n\n// Adjust Scale\nconst ratioX = Math.min(1, this.width / this.bitmap.width);\nconst ratioY = Math.min(1, this.height / this.bitmap.height);\nconst scale = Math.max(ratioX, ratioY);\nthis.scale.x = scale;\nthis.scale.y = scale;\n\n// Adjust Coordinates\nthis.x = (Graphics.width - this.width) / 2;\nthis.y = Graphics.height - this.height;"
 *
 ...
 * @option skill: name
 * @option combat log
 * @desc 如果沒有<Battle Commands>註釋標籤，則默認顯示的戰鬥命令列表。
 ...
 * @parent SvBattlers
 * @type boolean
 * @on 魔法命中(Magical Hit Type)
 * @off 魔法技能(Magical Skill Type)
 * @desc 決定詠唱動作的因素是什麼？
 * Hit type 還是 skill type?
 * @default true
 *
 * @param OffsetX:num
 * @text 偏移: X
 ...
 * @on 動作角色有優先權
 * @off 對動作角色一視同仁
 * @desc 將動作角色放在人物和敵人精靈(sprites)的上方。
 * @default false
 *
 ...
 * @on Last Selected
 * @off FV/SV Priority
 * @desc 將最後選擇的敵人放在優先於前視圖或側視圖設置的位置？
 * @default true
 *
 ...
 * @text 允許收合(Allow Collapse)
 * @parent SvBattlers
 * @type boolean
 * @on Allow
 * @off Don't
 * @desc 導致使用SV Battler圖形的敵人在被擊敗時"消失"？
 * @default false
 *
 * @param AnchorX:num
 * @text Anchor: X
 ...
 * @on 需要先擊中
 * @off 不需要先擊中
 * @desc 需要擊中敵人後才能顯示HP量條嗎？
 * 可以繞過<Show HP Gauge>註釋標籤。
 * @default true
 *
 ...
 * @on Automatic
 * @off Manual
 * @desc 是否將<Custom Action Sequence>便簽效果自動應用於具有共同事件的任何項目或技能？
 * @default false
 *
 * @param CastAnimations
 * @text 投放動畫(Cast Animations)
 *
